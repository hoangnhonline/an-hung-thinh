...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="{{ route('product.index') }}">Sửa sản phẩm</a></li>
  ...
  <section class="content">
    <a class="btn btn-default" href="{{ route('product.index') }}" style="margin-bottom:5px">Quay lại</a>
    <form role="form" method="POST" action="{{ route('product.update') }}">
    <div class="row">
      <!-- left column -->

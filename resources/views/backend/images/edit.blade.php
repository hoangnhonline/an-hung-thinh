...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="{{ route('images.index') }}">Sửa hình ảnh</a></li>
  ...
  <section class="content">
    <a class="btn btn-default" href="{{ route('images.index') }}" style="margin-bottom:5px">Quay lại</a>
    <form role="form" method="POST" action="{{ route('images.update') }}">
    <div class="row">
      <!-- left column -->
        ...
        <div class="box box-primary">
          ...
          <!-- /.box-header -->               
            ...
            <div class="box-body">
              ...
              @endif                
                <div class="form-group">
                  <label for="email">Album <span class="red-star">*</span></label>
                  <select class="form-control select2" name="album_id" id="album_id">
                    <option value="">-- chọn --</option>
                    @if( $cateArr->count() > 0)
                      @foreach( $cateArr as $value )
                      <option value="{{ $value->id }}" {{ $value->id == $detail->album_id ? "selected" : "" }}>{{ $value->name }}</option>
                      @endforeach
                    @endif
                  </select>
                </div>                           
            ...
            <div class="box-footer">
              ...
              <a class="btn btn-default" class="btn btn-primary" href="{{ route('images.index')}}">Hủy</a>
            </div>
